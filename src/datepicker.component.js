...
var DatepickerComponent = (function () {
    function DatepickerComponent(renderer, elementRef) {
        ...
        this.colors =
            { 'black': '#333333', 'blue': '#1285bf', 'lightGrey': '#f1f1f1', 'white': '#ffffff' };
        ...
        this.yearControl = new forms_1.FormControl('', forms_1.Validators.compose([
            forms_1.Validators.required, forms_1.Validators.maxLength(4), this.positiveIntegerValidator,
    ...
    DatepickerComponent.prototype.ngOnInit = function () { this.syncVisualsWithDate(); };
    DatepickerComponent.prototype.ngOnChanges = function (changes) {
        if ((changes['date'] || changes['dateFormat'])) {
            this.syncVisualsWithDate();
        }
    };
    DatepickerComponent.prototype.ngOnDestroy = function () { this.clickListener(); };
    DatepickerComponent.prototype.registerOnChange = function (fn) { this.propagateChange = fn; };
    ...
    DatepickerComponent.prototype.setHoveredDay = function (day) { this.hoveredDay = day; };
    DatepickerComponent.prototype.removeHoveredDay = function (day) { this.hoveredDay = null; };
    ...
    DatepickerComponent.prototype.onCancel = function () { this.closeCalendar(); };
    DatepickerComponent.prototype.onInputClick = function () { this.showCalendar = !this.showCalendar; };
